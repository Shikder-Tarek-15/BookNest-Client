...
const Navbar = () => {
  ...
  return (
    <div className="navbar  bg-base-300 rounded-b-md z-50">
      <div className="navbar-start">
        ...
        >
          Book
          <span className="bg-gradient-to-r from-blue-600 to-orange-600 inline-block text-transparent bg-clip-text -ml-2">
            Nest
          </span>
        </Link>
      </div>
